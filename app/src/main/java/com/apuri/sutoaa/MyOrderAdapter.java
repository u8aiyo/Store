...
public class MyOrderAdapter extends RecyclerView.Adapter<MyOrderAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyOrderAdapter.ViewHolder viewHolder, int position) {
        ...
        String orderStatus = myOrderItemModelList.get(position).getOrdersStatus();
        Date date;
        switch (orderStatus) {
            case "Ordered":
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(String resource, String title, String orderStatus, Date date, final int rating, final String productID, final int position) {
            ...
            if (orderStatus.equals("Cancelled")) {
                orderIndicator.setImageTintList(ColorStateList.valueOf(itemView.getContext().getColor(R.color.colorPrimary)));
            }
            else {
                orderIndicator.setImageTintList(ColorStateList.valueOf(itemView.getContext().getColor(R.color.colorSuccess)));
            }

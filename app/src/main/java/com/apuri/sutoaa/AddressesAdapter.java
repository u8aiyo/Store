...
import static com.apuri.sutoaa.MyAccountFragment.MANAGE_ADDRESS;
import static com.apuri.sutoaa.MyAddressesActivity.refreshItem;
...
public class AddressesAdapter extends RecyclerView.Adapter<AddressesAdapter.ViewHolder> {
    ...
    public AddressesAdapter(List<AddressesModel> addressesModelList, int MODE, @Nullable Dialog loadingDialog) {
    ...
    public void onBindViewHolder(@NonNull AddressesAdapter.ViewHolder viewHolder, int position) {
        ...
        viewHolder.setData(name, city, pinCode, selected, position, mobileNo, alternateMobileNo, flatNo, locality, stateSpinner, landmark);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            fullName = itemView.findViewById(R.id.name_textView);
            address = itemView.findViewById(R.id.address_textView);
            pinCode = itemView.findViewById(R.id.pin_code_textView);
            icon = itemView.findViewById(R.id.icon_view);
            optionLinearLayout = itemView.findViewById(R.id.option_container);
        }
        ...
        private void setData(String username, String city, String userPinCode, Boolean selected, final int position, String mobileNo, String alternateMobileNo, String flatNo, String locality, String state, String landmark) {
            ...
            if (MODE == SELECT_ADDRESS) {
                    ...
                    public void onClick(View v) { ////////////// remove address
                        ...
                        for (int i = 0; i < addressesModelList.size(); i++) {
                            if (i != position) {
                                ...
                                addresses.put("state_" + x, addressesModelList.get(i).getStateSpinner());
                        ...
                        FirebaseFirestore.getInstance().collection("USERS").document(FirebaseAuth.getInstance().getUid())
                                .collection("USER_DATA").document("MY_ADDRESSES").set(addresses)
                ...
                icon.setImageResource(R.drawable.menu_dot);

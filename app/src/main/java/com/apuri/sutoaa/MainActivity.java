...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        verified = navigationView.getHeaderView(0).findViewById(R.id.verified_account_icon);
                ...
                FirebaseFirestore.getInstance().collection("USERS").document(currentUser.getUid())
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            DBqueries.verified = task.getResult().getString("verified");
                            ...
                            Glide.with(MainActivity.this).load(DBqueries.verified).apply(new RequestOptions().placeholder(R.drawable.verified_account)).into(verified);
                        } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (currentFragment == HOME_FRAGMENT) {
            ...
            MenuItem cartItem = menu.findItem(R.id.action_cart_icon);
            ...
            if (currentUser != null) {
                ...
                if (DBqueries.cartList.size() == 0) {
                    DBqueries.loadCartList(MainActivity.this, new Dialog(MainActivity.this), false, budgeCount, new TextView(MainActivity.this));
                }
                else {
            ...
            ////////////////////////////// Notification
            MenuItem notifyItem = menu.findItem(R.id.action_notification_icon);
